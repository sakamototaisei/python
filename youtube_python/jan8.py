...
while True:
    ...
    print('あなたが出した手は{} CPが出した手は{}'.format(hands_dict.get(my_hand), hands_dict.get(enemy_hand)))
    if my_hand == enemy_hand:
        ...
        if win_count == 3:
            ...
            print('{}回勝ちました。'.format(win_count))
    else:
        lose_count += 1
        if lose_count == 3:
            print('3回負けました。あなたの負けです。')
            break
        else:
            print('{}回目けました。再チャレンジ。'.format(lose_count))