...
while True:
    ...
    print('あなたの出した手は: {}, 相手が出したては: {}'.format(hands_dict.get(my_hand), hands_dict.get(enemy_hand)))
    if my_hand == enemy_hand:
        print('あいこです')
    elif is_win(my_hand, enemy_hand):
        win_count += 1
        if win_count == 3:
            print('あなたは3回勝ちました！あなたの勝利です！')
            break
        else:
        ...
        if lose_count == 3:
            ...
            print('あなたは{}負けました。再チャレンジ！'.format(str(lose_count)))